            ...
            <div className="everythingDetails" id="blur">
                ...
                <div >
                    <div className="photos">
                        <img className="detailsImg" src={product.photo1} alt="details"/>
                        <img className="detailsImg" src={product.photo2} alt="details"/>
                        <img className="detailsImg" src={product.photo3} alt="details"/>
                        <img className="detailsImg" src={product.photo4} alt="details"/>
                    </div >
